...
class KNN(object):
    ...
    def compute_L2_distances_vectorized(self, X):
        ...
        test_square = np.reshape(test_square, (test_square.shape[0], 1))    
        dists = np.sqrt(test_square + train_square - np.multiply(M, 2))
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            closest_y = [self.y_train[index] for index in indices]       
